...
# import Excel tabs
file <- list.files(pattern = "^Metabarcoding Results - .*\\.xlsx$")[1]
...
output <- merge(wb1, df, by.x = "ASV_ID", by.y = "Query", all.x = TRUE)
...
setColWidths(wb,"By Sample",cols = 3,widths = "13") #asv
